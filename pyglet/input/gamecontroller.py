...
def add_mappings_from_file(filename):
    ...
    with open(filename) as f:
        for line in f.readlines():
            ...
            # TODO: consider if existing mappings should be overwritten
            # Add the mapping to the list if it doesn't already exist.
...
def is_game_controller(device):
    ...
    """
    return any(device.guid == m["guid"] for m in mapping_list)
...
mapping_list = [
    {'guid': '03000000022000000090000011010000', 'name': '8Bitdo NES30 Pro', 'guide': None, 'a': ('button', 1),
     'b': ('button', 0), 'x': ('button', 4), 'y': ('button', 3), 'leftshoulder': ('button', 6),
     'leftstick': ('button', 13), 'rightshoulder': ('button', 7), 'rightstick': ('button', 14), 'back': ('button', 10),
     'start': ('button', 11), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 8), 'righttrigger': ('button', 9), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '05000000203800000900000000010000', 'name': '8Bitdo NES30 Pro', 'guide': None, 'a': ('button', 1),
     'b': ('button', 0), 'x': ('button', 4), 'y': ('button', 3), 'leftshoulder': ('button', 6),
     'leftstick': ('button', 13), 'rightshoulder': ('button', 7), 'rightstick': ('button', 14), 'back': ('button', 10),
     'start': ('button', 11), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 8), 'righttrigger': ('button', 9), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '05000000102800000900000000010000', 'name': '8Bitdo SFC30 GamePad', 'guide': None, 'a': ('button', 1),
     'b': ('button', 0), 'x': ('button', 4), 'y': ('button', 3), 'leftshoulder': ('button', 6), 'leftstick': None,
     'rightshoulder': ('button', 7), 'rightstick': None, 'back': ('button', 10), 'start': ('button', 11), 'dpup': None,
     'dpdown': None, 'dpleft': None, 'dpright': None, 'lefttrigger': None, 'righttrigger': None, 'leftx': ('axis', 0),
     'lefty': ('axis', 1), 'rightx': None, 'righty': None},
    {'guid': '05000000a00500003232000008010000', 'name': '8Bitdo Zero GamePad', 'guide': None, 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 4), 'leftshoulder': ('button', 6), 'leftstick': None,
     'rightshoulder': ('button', 7), 'rightstick': None, 'back': ('button', 10), 'start': ('button', 11), 'dpup': None,
     'dpdown': None, 'dpleft': None, 'dpright': None, 'lefttrigger': None, 'righttrigger': None, 'leftx': None,
     'lefty': None, 'rightx': None, 'righty': None},
    {'guid': '03000000100000008200000011010000', 'name': 'Akishop Customs PS360+ v1.66', 'guide': ('button', 8),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 12),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': None, 'lefty': None, 'rightx': None,
     'righty': None},
    {'guid': '03000000e82000006058000001010000', 'name': 'Cideko AK08b', 'guide': None, 'a': ('button', 2),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 0), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000260900008888000000010000', 'name': 'Cyber Gadget GameCube Controller', 'guide': None,
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': None,
     'leftstick': None, 'rightshoulder': ('button', 6), 'rightstick': None, 'back': None, 'start': ('button', 7),
     'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 4), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000790000000600000010010000', 'name': 'DragonRise Inc. Generic USB Joystick', 'guide': None,
     'a': ('button', 2), 'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 0), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '0500000047532047616d657061640000', 'name': 'GameStop Gamepad', 'guide': None, 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000006f0e00000104000000010000', 'name': 'Gamestop Logic3 Controller', 'guide': ('button', 8),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000000d0f00005f00000011010000', 'name': 'Hori Fighting Commander 4 (PS3)', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000000d0f00005e00000011010000', 'name': 'Hori Fighting Commander 4 (PS4)', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '030000008f0e00001330000010010000', 'name': 'HuiJia SNES Controller', 'guide': None, 'a': ('button', 2),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 0), 'leftshoulder': ('button', 6), 'leftstick': None,
     'rightshoulder': ('button', 7), 'rightstick': None, 'back': ('button', 8), 'start': ('button', 9), 'dpup': None,
     'dpdown': None, 'dpleft': None, 'dpright': None, 'lefttrigger': None, 'righttrigger': None, 'leftx': None,
     'lefty': None, 'rightx': None, 'righty': None},
    {'guid': '03000000ba2200002010000001010000', 'name': 'Jess Technology USB Game Controller', 'guide': None,
     'a': ('button', 2), 'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 0), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 2)},
    {'guid': '030000006d04000019c2000010010000', 'name': 'Logitech Cordless RumblePad 2', 'guide': None,
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000006d04000016c2000011010000', 'name': 'Logitech Dual Action', 'guide': None, 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000006d04000016c2000010010000', 'name': 'Logitech Dual Action', 'guide': None, 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000006d0400001dc2000014400000', 'name': 'Logitech F310 Gamepad (XInput)', 'guide': ('button', 8),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000006d0400001ec2000020200000', 'name': 'Logitech F510 Gamepad (XInput)', 'guide': ('button', 8),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000006d04000019c2000011010000', 'name': 'Logitech F710 Gamepad (DInput)', 'guide': None,
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000006d0400001fc2000005030000', 'name': 'Logitech F710 Gamepad (XInput)', 'guide': ('button', 8),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000006d04000018c2000010010000', 'name': 'Logitech RumblePad 2', 'guide': None, 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000380700008433000011010000', 'name': 'Mad Catz FightStick TE S+ PS3', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000380700008483000011010000', 'name': 'Mad Catz FightStick TE S+ PS4', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '03000000380700003847000090040000', 'name': 'Mad Catz Wired Xbox 360 Controller (SFIV)',
     'guide': ('button', 10), 'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3),
     'leftshoulder': ('button', 4), 'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None,
     'back': ('button', 8), 'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8),
     'dpright': ('hat0', 2), 'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0),
     'lefty': ('axis', 1), 'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000380700008034000011010000', 'name': 'Mad Catz fightstick (PS3)', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000380700008084000011010000', 'name': 'Mad Catz fightstick (PS4)', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '03000000380700001888000010010000', 'name': 'MadCatz PC USB Wired Stick 8818', 'guide': ('button', 12),
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': None, 'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000790000004418000010010000', 'name': 'Mayflash GameCube Controller', 'guide': None,
     'a': ('button', 1), 'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': None,
     'leftstick': None, 'rightshoulder': ('button', 7), 'rightstick': None, 'back': None, 'start': ('button', 9),
     'dpup': ('button', 12), 'dpdown': ('button', 14), 'dpleft': ('button', 15), 'dpright': ('button', 13),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 5), 'righty': ('axis', 2)},
    {'guid': '030000001008000001e5000010010000', 'name': 'NEXT SNES Controller', 'guide': None, 'a': ('button', 2),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 0), 'leftshoulder': ('button', 4), 'leftstick': None,
     'rightshoulder': ('button', 6), 'rightstick': None, 'back': ('button', 8), 'start': ('button', 9), 'dpup': None,
     'dpdown': None, 'dpleft': None, 'dpright': None, 'lefttrigger': None, 'righttrigger': None, 'leftx': None,
     'lefty': None, 'rightx': None, 'righty': None},
    {'guid': '03000000550900001072000011010000', 'name': 'NVIDIA Controller', 'guide': ('button', 13),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 8), 'rightshoulder': ('button', 5), 'rightstick': ('button', 9), 'back': None,
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 5), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '050000007e0500003003000001000000', 'name': 'Nintendo Wii Remote Pro Controller', 'guide': ('button', 10),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 11), 'rightshoulder': ('button', 5), 'rightstick': ('button', 12), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('button', 13), 'dpdown': ('button', 14), 'dpleft': ('button', 15),
     'dpright': ('button', 16), 'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0),
     'lefty': ('axis', 1), 'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000000d0500000308000010010000', 'name': 'Nostromo n45 Dual Analog Gamepad', 'guide': ('button', 9),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 12), 'rightshoulder': ('button', 6), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 10), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 5), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 2)},
    {'guid': '05000000362800000100000002010000', 'name': 'OUYA Game Controller', 'guide': ('button', 14),
     'a': ('button', 0), 'b': ('button', 3), 'x': ('button', 1), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 6), 'rightshoulder': ('button', 5), 'rightstick': ('button', 7), 'back': None,
     'start': None, 'dpup': ('button', 8), 'dpdown': ('button', 9), 'dpleft': ('button', 10), 'dpright': ('button', 11),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000004c0500006802000010010000', 'name': 'PS3 Controller', 'guide': ('button', 16), 'a': ('button', 14),
     'b': ('button', 13), 'x': ('button', 15), 'y': ('button', 12), 'leftshoulder': ('button', 10),
     'leftstick': ('button', 1), 'rightshoulder': ('button', 11), 'rightstick': ('button', 2), 'back': ('button', 0),
     'start': ('button', 3), 'dpup': ('button', 4), 'dpdown': ('button', 6), 'dpleft': ('button', 7),
     'dpright': ('button', 5), 'lefttrigger': ('button', 8), 'righttrigger': ('button', 9), 'leftx': ('axis', 0),
     'lefty': ('axis', 1), 'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '050000004c0500006802000000010000', 'name': 'PS3 Controller', 'guide': ('button', 16), 'a': ('button', 14),
     'b': ('button', 13), 'x': ('button', 15), 'y': ('button', 12), 'leftshoulder': ('button', 10),
     'leftstick': ('button', 1), 'rightshoulder': ('button', 11), 'rightstick': ('button', 2), 'back': ('button', 0),
     'start': ('button', 3), 'dpup': ('button', 4), 'dpdown': ('button', 6), 'dpleft': ('button', 7),
     'dpright': ('button', 5), 'lefttrigger': ('axis', 12), 'righttrigger': ('axis', 13), 'leftx': ('axis', 0),
     'lefty': ('axis', 1), 'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000004c0500006802000011010000', 'name': 'PS3 Controller', 'guide': ('button', 16), 'a': ('button', 14),
     'b': ('button', 13), 'x': ('button', 15), 'y': ('button', 12), 'leftshoulder': ('button', 10),
     'leftstick': ('button', 1), 'rightshoulder': ('button', 11), 'rightstick': ('button', 2), 'back': ('button', 0),
     'start': ('button', 3), 'dpup': ('button', 4), 'dpdown': ('button', 6), 'dpleft': ('button', 7),
     'dpright': ('button', 5), 'lefttrigger': ('button', 8), 'righttrigger': ('button', 9), 'leftx': ('axis', 0),
     'lefty': ('axis', 1), 'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '03000000341a00003608000011010000', 'name': 'PS3 Controller', 'guide': ('button', 12), 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('button', 6), 'righttrigger': ('button', 7), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '030000004c050000c405000011010000', 'name': 'PS4 Controller', 'guide': ('button', 12), 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '050000004c050000c405000000010000', 'name': 'PS4 Controller', 'guide': ('button', 12), 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '030000004c050000cc09000011010000', 'name': 'PS4 Controller', 'guide': ('button', 12), 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '050000004c050000cc09000000010000', 'name': 'PS4 Controller', 'guide': ('button', 12), 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '030000004c050000a00b000011010000', 'name': 'PS4 Controller', 'guide': ('button', 12), 'a': ('button', 1),
     'b': ('button', 2), 'x': ('button', 0), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 10), 'rightshoulder': ('button', 5), 'rightstick': ('button', 11), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 3), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '030000004c050000c405000011810000', 'name': 'PS4 Controller', 'guide': ('button', 10), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 11), 'rightshoulder': ('button', 5), 'rightstick': ('button', 12), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '050000004c050000c405000000810000', 'name': 'PS4 Controller', 'guide': ('button', 10), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 11), 'rightshoulder': ('button', 5), 'rightstick': ('button', 12), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000004c050000cc09000011810000', 'name': 'PS4 Controller', 'guide': ('button', 10), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 11), 'rightshoulder': ('button', 5), 'rightstick': ('button', 12), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '050000004c050000cc09000000810000', 'name': 'PS4 Controller', 'guide': ('button', 10), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 11), 'rightshoulder': ('button', 5), 'rightstick': ('button', 12), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '030000004c050000a00b000011810000', 'name': 'PS4 Controller', 'guide': ('button', 10), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 11), 'rightshoulder': ('button', 5), 'rightstick': ('button', 12), 'back': ('button', 8),
     'start': ('button', 9), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '03000000c6240000045d000025010000', 'name': 'Razer Sabertooth', 'guide': ('button', 8), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '03000000321500000009000011010000', 'name': 'Razer Serval', 'guide': ('button', 8), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 5), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '050000003215000000090000163a0000', 'name': 'Razer Serval', 'guide': ('button', 8), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 5), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '0300000032150000030a000001010000', 'name': 'Razer Wildcat', 'guide': ('button', 8), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '03000000790000001100000010010000', 'name': 'Retrolink SNES Controller', 'guide': None, 'a': ('button', 2),
     'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 0), 'leftshoulder': ('button', 4), 'leftstick': None,
     'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 8), 'start': ('button', 9), 'dpup': None,
     'dpdown': None, 'dpleft': None, 'dpright': None, 'lefttrigger': None, 'righttrigger': None, 'leftx': None,
     'lefty': None, 'rightx': None, 'righty': None},
    {'guid': '03000000de280000fc11000001000000', 'name': 'Steam Controller', 'guide': ('button', 8), 'a': ('button', 0),
     'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 9), 'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': 'xinput', 'name': 'XInput Controller', 'guide': ('button', 8), 'a': ('button', 0), 'b': ('button', 1),
     'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4), 'leftstick': ('button', 9),
     'rightshoulder': ('button', 5), 'rightstick': ('button', 10), 'back': ('button', 6), 'start': ('button', 7),
     'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '050000005e040000e002000003090000', 'name': 'Xbox One Wireless Controller', 'guide': ('button', 10),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 2), 'y': ('button', 3), 'leftshoulder': ('button', 4),
     'leftstick': ('button', 8), 'rightshoulder': ('button', 5), 'rightstick': ('button', 9), 'back': ('button', 6),
     'start': ('button', 7), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 2), 'righttrigger': ('axis', 5), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 3), 'righty': ('axis', 4)},
    {'guid': '050000005e040000fd02000003090000', 'name': 'Xbox One Wireless Controller', 'guide': ('button', 16),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 4), 'leftshoulder': ('button', 6),
     'leftstick': ('button', 13), 'rightshoulder': ('button', 7), 'rightstick': ('button', 14), 'back': ('button', 15),
     'start': ('button', 11), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 5), 'righttrigger': ('axis', 4), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 3)},
    {'guid': '05000000172700004431000029010000', 'name': 'XiaoMi Game Controller', 'guide': ('button', 20),
     'a': ('button', 0), 'b': ('button', 1), 'x': ('button', 3), 'y': ('button', 4), 'leftshoulder': ('button', 6),
     'leftstick': ('button', 13), 'rightshoulder': ('button', 7), 'rightstick': ('button', 14), 'back': ('button', 10),
     'start': ('button', 11), 'dpup': ('hat0', 1), 'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'dpright': ('hat0', 2),
     'lefttrigger': ('axis', 7), 'righttrigger': ('axis', 6), 'leftx': ('axis', 0), 'lefty': ('axis', 1),
     'rightx': ('axis', 2), 'righty': ('axis', 5)},
    {'guid': '03000000830500006020000010010000', 'name': 'iBuffalo SNES Controller', 'guide': None, 'a': ('button', 1),
     'b': ('button', 0), 'x': ('button', 3), 'y': ('button', 2), 'leftshoulder': ('button', 4), 'leftstick': None,
     'rightshoulder': ('button', 5), 'rightstick': None, 'back': ('button', 6), 'start': ('button', 7), 'dpup': None,
     'dpdown': None, 'dpleft': None, 'dpright': None, 'lefttrigger': None, 'righttrigger': None, 'leftx': None,
     'lefty': None, 'rightx': None, 'righty': None},
    # Windows from here:
    {'lefttrigger': ('button', 5), 'leftshoulder': ('button', 4),
     'dpright': ('hat0', 2), 'platform': 'Windows', 'y': ('button', 3), 'guide': None,
     ...
     'dpup': ('hat0', 1), 'righty': ('axis', 2), 'a': ('button', 0), 'b': ('button', 1),
    ...
    {'lefttrigger': ('button', 6), 'leftshoulder': ('button', 4),
     ...
     'guide': ('button', 12), 'name': 'Afterglow PS3 Controller', 'lefty': ('axis', 1),
    ...
    {'lefttrigger': ('button', 6), 'leftshoulder': ('button', 4),
     ...
     'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'back': ('button', 8),
     'dpup': ('hat0', 1), 'righty': ('axis', 3), 'a': ('button', 1), 'b': ('button', 2),
     'leftx': ('axis', 0), 'rightstick': ('button', 11), 'leftstick': ('button', 10),
    ...
    {'lefttrigger': ('button', 4), 'leftshoulder': ('button', 6),
     ...
     'dpup': ('hat0', 1), 'righty': ('axis', 3), 'a': ('button', 2), 'b': ('button', 1),
     'leftx': ('axis', 0), 'rightstick': ('button', 11), 'leftstick': ('button', 10),
    ...
    {'lefttrigger': ('button', 6), 'leftshoulder': ('button', 4),
     'dpright': ('hat0', 2), 'platform': 'Windows', 'y': ('button', 3), 'guide': None,
     'name': 'Logitech RumblePad 2 USB', 'lefty': ('axis', 1), 'start': ('button', 9),
     'righttrigger': ('button', 7), 'rightx': ('axis', 2), 'x': ('button', 0),
     'dpdown': ('hat0', 4), 'dpleft': ('hat0', 8), 'back': ('button', 8),
     'dpup': ('hat0', 1), 'righty': ('axis', 3), 'a': ('button', 1), 'b': ('button', 2),
     'leftx': ('axis', 0), 'rightstick': ('button', 11), 'leftstick': ('button', 10),
    ...
    {'lefttrigger': ('button', 5), 'leftshoulder': ('button', 4),
     ...
     'leftx': ('axis', 0), 'rightstick': ('button', 12), 'leftstick': ('button', 11),
    ...
    {'lefttrigger': ('button', 6), 'leftshoulder': ('axis', 3), 'dpright': ('hat0', 2),
     ...
     'dpup': ('hat0', 1), 'righty': ('hat0', 4), 'a': ('button', 0), 'b': ('button', 1),
    ...
    {'lefttrigger': None, 'leftshoulder': ('button', 6), 'dpright': ('hat0', 2),
     ...
     'dpup': ('hat0', 1), 'righty': ('axis', 3), 'a': ('button', 2), 'b': ('button', 3),
    ...
    {'lefttrigger': None, 'leftshoulder': ('button', 4), 'dpright': None,
     ...
     'start': ('button', 7), 'righttrigger': None, 'rightx': None, 'x': ('button', 3),
